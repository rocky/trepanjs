...
function defineCommands(intf, Interface) {
	...
	help: "Type help('command-name') to get help for a command.\n\
...
current one we are stopped at.",
	...
	help: "list([count]): list next source-code lines.\n\
If count isn't given, list 10 lines",
	connection: true,
